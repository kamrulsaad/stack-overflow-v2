    ...
    return (
        <div className='flex h-16 items-center gap-x-2 border-b border-slate-50'>
            ...
            <div className='w-full flex justify-between items-center'>
                <input placeholder='Search' className='ml-4 w-80 border border-slate-200 rounded-full p-2 pl-10 text-sm focus:outline-none' style={{ background: "url('assets/search.svg') no-repeat", backgroundSize: "15px", backgroundPosition: "center left 10px" }} type="text" />
